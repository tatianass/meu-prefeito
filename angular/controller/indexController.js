app.controller("IndexController", ["$scope", "$http", "ngTableParams", "$filter", function($scope, $http, ngTableParams, $filter){
    ...
    $scope.usersTable = new ngTableParams({
                ...
                getData: function ($defer, params) {
                    $scope.data = params.sorting() ? $filter("orderBy")($scope.dados, params.orderBy()) : $scope.dados;
