app.controller("IndexController", ["$scope", "$http", function($scope, $http){
    ...
    $scope.value = 0;
    $scope.info = {}
    $scope.infoPB = {"Ini_Gestao":2013,"Media_Contratos_PB":265.2277,"Media_Dispensas_PB":27.9062,"Media_Aditivos_Prazo_PB":29.5045,"Media_Aditivos_Valor_PB":40.6161,"Media_Convites_PB":23.0402,"IDHM_PB":0.5878,"IDHM_E_PB":0.4775,"IDHM_L_PB":0.7558,"IDHM_R_PB":0.5645,"Ind_Escolaridade_PB":0.3003,"Exp_Vida_PB":70.3435,"Media_Dispensas_PB_Percent":0.1052,"Media_Convite_PB_Percent":0.0869,"Media_Aditivos_Prazo_PB_Percent":0.1112,"Media_Aditivos_Valor_PB_Percent":0.1531}
    $scope.featureData = {}
